...
- differences introduced by the evaluation environment.
...
works, record the reusable setup pattern in project evaluation knowledge: dependency
...
- candidate reusable evaluation knowledge; and
