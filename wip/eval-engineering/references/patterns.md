...
boundaries. Add health checks for
dependencies.
...
Separate Environment build errors, service startup failures, runtime timeouts,
and Verifier errors from Task failure. Agent exhaustion of a functioning task
budget remains a task outcome; classify it using [Calibration](calibration.md).
...
Store proven project-specific adaptations in the companion AGENTS.md. Keep the
