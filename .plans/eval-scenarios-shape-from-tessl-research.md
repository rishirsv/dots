# Eval Scenarios Shape From Tessl And Notion Research
...
- Tessl quality pages: base quality phases and universal dimensions.
- Tessl eval pages: scenario-level evidence should compare baseline risk and
...
- `evaluate-skill` owns `.meta-skill/evals/<ID-slug>/eval.md` and
