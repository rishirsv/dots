...
A deterministic structural task used by `scripts/meta-skill validate`. These checks
...
def main(argv=None):
    ap = argparse.ArgumentParser(description="Internal validator. Agent-facing usage: scripts/meta-skill validate <skill-dir>.")
