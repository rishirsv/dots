...
|---|---|---|---|
| **Default / simple** | A small feature, product change, or settled conversation needs a clear durable artifact. | [assets/PRD_template.md](../assets/PRD_template.md) | Problem, outcome, user/job, proposed shape, scope, acceptance, notes, open questions. |
...
- Prefer acceptance criteria over generic user-story lists.
