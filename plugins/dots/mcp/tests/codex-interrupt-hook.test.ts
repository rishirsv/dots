...
test("Interrupt hook command is absolute, quoted, and bound to the exact application home", () => {
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["/Applications/Portal.app/runtime/bun", "/Applications/Portal.app/app/cli.js"] },
    "/Users/test/Application Support/Portal",
    "darwin",
  )).toBe(
    "'/Applications/Portal.app/runtime/bun' '/Applications/Portal.app/app/cli.js'"
      + " '--home' '/Users/test/Application Support/Portal' 'hook' 'interrupt'",
  );
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["C:\\Program Files\\Portal\\bun.exe", "C:\\Program Files\\Portal\\cli.js"] },
    "C:\\Users\\test\\Portal",
    "win32",
  )).toBe(
    '"C:\\Program Files\\Portal\\bun.exe" "C:\\Program Files\\Portal\\cli.js"'
      + ' "--home" "C:\\Users\\test\\Portal" "hook" "interrupt"',
  );
});
