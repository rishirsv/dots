...
export const LAUNCHER_BROWSER_HOST_KIND = "portal-launcher";
export const LAUNCHER_BROWSER_IDLE_URL = "data:text/html;charset=utf-8,%3C!doctype%20html%3E%3Chtml%3E%3Chead%3E%3Cmeta%20charset%3D%22utf-8%22%3E%3Ctitle%3EPortal%3C%2Ftitle%3E%3C%2Fhead%3E%3Cbody%3E%3C%2Fbody%3E%3C%2Fhtml%3E#portal-browser-host";
export type LauncherBrowserHostProfile = "production";
...
function assertDescriptorShape(value: unknown): LauncherBrowserHostDescriptor {
  ...
  const expectedPartition = "persist:portal-chatgpt";
...
export interface LauncherManualTurnStart extends LauncherManualTurnOwner {
  ...
  resumePrompt?: string;
  conversationKey?: string;
  /** Gives a manual context handoff enough time without widening ordinary Portal manual turns. */
  compaction?: true;
}
