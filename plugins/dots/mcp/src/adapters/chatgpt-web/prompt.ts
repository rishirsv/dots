...
import { CHATGPT_WEB_LUNA_MODEL_ID, CHATGPT_WEB_MODEL_ID, isChatGptWebZeroRiskBackendModel, resolveChatGptWebModelMode, type ChatGptWebCapabilities } from "./model";
import {
...
export function chatGptReadOnlyContextWarning(
  ...
  const browserOnlyGuidance = !capabilities.localToolsEnabled
    ? "\n>\n> **Action:** Open Portal and connect its MCP tunnel to give ChatGPT Web Pro access to this task's tools."
    : "";
  if (hasLocalEvidence) {
