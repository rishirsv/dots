...
const CHATGPT_WEB_ZERO_RISK_MODEL_ID = "chatgpt-web-zero-risk";
const CHATGPT_WEB_ZERO_RISK_PRO_MODEL_ID = "chatgpt-web-zero-risk-pro";

export function isChatGptWebZeroRiskBackendModel(modelId: string): boolean {
  return modelId === CHATGPT_WEB_ZERO_RISK_MODEL_ID || modelId === CHATGPT_WEB_ZERO_RISK_PRO_MODEL_ID;
}
