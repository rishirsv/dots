...
A periodic **Code Janitor** pass keeps the same Simplify coverage but may divide
...
Simplify lenses; the parent confirms that Reuse, Quality, and Efficiency remain
