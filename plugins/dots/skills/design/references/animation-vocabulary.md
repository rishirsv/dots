...
Read this on demand when forming a motion brief, choosing or combining motion
techniques, critiquing an interaction, or translating vague motion direction
into precise language. Use the terms below as the shared vocabulary; do not
load this reference for design work with no motion or interaction component.
