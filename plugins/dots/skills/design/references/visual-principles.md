...
Read this before choosing visual direction, typography, layout language, or a
polish pass.
...
If the brief does not pin down the product or subject, pin it through the brief
process before designing: name one concrete subject, its audience, and the
surface's single job.

Distinctive choices should come from the subject's own world: materials,
...
sizes or collage systems unless the brief calls for that direction.
...
Copy can make a design feel as templated as layout. Use concrete, subject-aware
language. Preserve user-provided exact copy. When copy is missing, write
specific, plausible labels and microcopy that match the product, audience, and
state.

Avoid fake metrics, fake jargon, generic brand names, repeated section formulas,
and filler proof points. If a design needs data, use realistic ranges and states
from the brief.

## Polish Review

Before final delivery, critique the work like a design lead:

- Does the design visibly belong to this product or subject?
- Does the first viewport state the product's purpose and priority?
- Does the visual hierarchy make the primary action or idea obvious?
