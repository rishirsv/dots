...
body. Do not use a disposable branch as a media host: its URLs break when the
branch is deleted. Use tracked repository assets only when repository policy or
the user explicitly selects a durable location.
