...
| Decision document | A final decision with rationale and consequences | Save only after a real decision is made or the user requests a record. |
...
the evidence, tradeoffs or implications, important risks, and open questions.
