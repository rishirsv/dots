...
10. **Notice changed source files that are becoming hard to navigate.** When a
...
Explicitly ask for behavior-preserving structural simplifications that make the
implementation dramatically smaller, more direct, or more natural in the
