...
changes, cleans, analyzes, or checks spreadsheets. Use the applicable controls
...
## Inspection, failure behavior, and evaluator cases
...
features. Specify the expected outputs, controls, preserved structures, rendered surfaces, and
