---
name: visualize
description: "Creates rich inline visual content, including SVG diagrams, UI mockups, interactive explainers, charts, and generative art, using the Imagine visual creation guidance. Use when the user asks to visualize, diagram, mock up, chart, illustrate, or make an interactive visual explanation."
---
