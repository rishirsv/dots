...
|---|---|---|
| Sessions | Raw replayable transcripts (evidence) | thread-index rollout paths |
...
- **Record scope, rationale, exceptions, and a bad/good example** for non-trivial
  rules. Keep evidence provenance in the proposal or decision record rather
  than copying thread IDs or transcript paths into AGENTS.md.
