...
For web examples, read the relevant section of
[motion-recipes.md](../assets/motion-recipes.md). For native interfaces, use the
platform's animation, gesture, accessibility, and lifecycle facilities.
