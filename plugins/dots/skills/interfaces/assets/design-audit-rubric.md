...
| U2 | Information architecture and cognitive load | Does organization match the user's mental model? Check necessary content, grouping semantics, prioritization, redundancy, task-appropriate density, and progressive disclosure. Consider what can be removed or deferred without hiding essential functionality. |
