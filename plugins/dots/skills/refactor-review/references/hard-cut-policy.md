...
Read this when a refactor review finds old-shape handling, fallbacks, compatibility branches, shims, adapters, coercions, aliases, dual-shape support, or migration residue.
