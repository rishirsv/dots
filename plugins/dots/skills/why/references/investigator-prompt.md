...
3. **Follow links within your assigned source.** If a PR references another PR or commit, pull it. If a ticket links a parent or sibling, pull it. If a doc links another doc, pull it. Stay inside your assigned source. When you spot a cross-source reference, do NOT chase it yourself. Record it under "Additional Leads" so the parent can route it to an assigned investigator or decide whether to expand the search. Chasing cross-source links yourself duplicates work and changes the assigned scope.
