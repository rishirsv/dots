...
def build_parser():
    ...
    init.add_argument("--evals", action="store_true", help="Also create the standard evals directory")
    ...
    def add_run_arguments(command, *, check=False):
        ...
        command.add_argument("--gate", action="store_true", help="Exit non-zero on variant regressions or unknown outcomes")
