...
A maintainer has an existing skill with `fixtures/eval-scenarios.md`, eval criteria files, and a generated `fixtures/review.md` worksheet. The maintainer wants a read-only quality review, not source edits.
...
Complete the read-only review from the generated worksheet and existing evidence fixtures.
