...
domain knowledge, scripts, templates, and other resources that would be
wasteful or unreliable to reconstruct on every run.

## How Skills Work

Skills disclose information in layers:

1. The `name` and `description` are always visible and decide discovery.
