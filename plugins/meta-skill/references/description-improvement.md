...
Keep this discovery corpus separate from scenario-based task-outcome scenarios. Store it
as an explicit custom eval in the skill companion until an execution adapter
can reproduce the real discovery surface faithfully.
