...
A Verify-tests task used by `scripts/meta-skill validate` covering the *mechanical*
...
central CLI can aggregate it. Heuristic checks flag as Warning (advisory) to
avoid hard-failing on a borderline call. Pure stdlib.
"""
...
def main(argv=None):
    ap = argparse.ArgumentParser(description="Internal linter. Agent-facing usage: scripts/meta-skill validate <skill-dir>.")
