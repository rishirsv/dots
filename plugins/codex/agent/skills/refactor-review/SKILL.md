...
description: "Use when scanning a codebase for refactoring or architecture improvement opportunities, improving codebase architecture, deepening modules, consolidating ownership, reducing architecture drift, or reviewing after the fact for larger structural improvements; not for post-implementation diff cleanup, existing PR review-comment response, CI repair, publishing PRs, or direct feature implementation."
---
