...
Look for the seed plan/spec, target implementation files, source-of-truth docs/config, nearby tests or fixtures, repo instructions, relevant diffs, and commands that would verify the final plan. Exclude broad docs, generated mirrors, and unrelated dirty files unless the plan explicitly depends on them.
