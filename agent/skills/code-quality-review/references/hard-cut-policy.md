...
Read this when a review or cleanup touches schemas, contracts, persisted state, routing, configuration, feature flags, enum/value sets, architecture, migrations, fallbacks, adapters, or compatibility paths.
