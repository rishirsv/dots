...
- preserve the existing design conventions, tokens, component patterns, and interaction language unless the user explicitly asks for a new direction
...
When working in an existing repo, apply these iOS-native rules in a way that reinforces the product’s current design language rather than replacing it.
