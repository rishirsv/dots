---
name: oracle
description: "Prepare a repo-context handoff for an external model. Use when the user explicitly asks to package a repository slice for ChatGPT Pro or another outside reviewer."
---
...
Use the installed skill path so Oracle works from any repo:
