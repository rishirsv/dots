...
- [Common Detent Values](#common-detent-values)
- [Complete Example](#complete-example)
- [Troubleshooting](#troubleshooting)


This guide covers implementing form sheets with footers using Expo Router's Stack navigator and react-native-screens.
