...
- [Stacks and Tabs Structure](#stacks-and-tabs-structure)
- [Array Routes for Multiple Stacks](#array-routes-for-multiple-stacks)
- [Complete App Structure Example](#complete-app-structure-example)
