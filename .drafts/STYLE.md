...
This is my canonical guide for argument, evidence, structure, and readiness. Sentence sound belongs in `VOICE.md`.
...
A piece is ready for my review when the central point is clear; examples support it; the proposed answer addresses the named obstacle; consequential claims have provenance; material objections have been considered; and the ending moves the thought forward. Check its language against `VOICE.md`.
