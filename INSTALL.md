...
```sh
scripts/sync-configs.sh --dry-run --codex --claude --vscode --ghostty --cmux --starship --zsh --launchagents --karabiner
scripts/sync-configs.sh --codex --claude --vscode --ghostty --cmux --starship --zsh --launchagents --karabiner
```
