# Report Extraction: project-cinema-report
...
- Theatre exhibition is the Company’s core business. Box office revenues are highly dependent on the marketability, quality, and appeal of the film product released. Furthermore, the Company’s theatre concession service offers a range of food choices that are meant to compliment and enhance the theatre The Company operates LBE establishments under the brand names “The
- Rec Room” and “Playdium.” The Rec Room is a social entertainment destination that targets millennials featuring a wide range of entertainment options including video, recreational gaming, and live entertainment.
- Playdium is an arcade destination targeting families and teenagers in midThe Company’s media branch serves businesses over two major

# Summary Financials
- related to theatre exhibition, and digital place-based media which provides digital signage solutions and in-store related media networks for leading brands in shopping centers and other entertainment destinations.
- The Company’s core operating segments include 1) film entertainment and content 2) media and 3) location based entertainment. Film entertainment and content contributed $1.38 billion to the Company’s total revenues in the TTM Mar-24 period, media contributed $141.0 million, and location based entertainment contributed
- Cineplex Revenue by Segment The Company’s stock price has decreased by 19.8% from $9.27 to $7.43 throughout the scope period.
...
- Realty tax subsidies: The Canadian Government’s realty tax subsidy program included support for company realty tax. This subsidy was retroactive from Q1-21 to Q1-22 within the scope period. The Company records this grant as an offset to the relevant expense.
- Diligence adjustments (continued)
- Revenue, pro forma adjusted
- Removal of P1AG revenue
- Realized foreign exchange gain (loss)
- Removal of P1AG impact 12. New LBE locations: Management states that it plans to open 3 new location based entertainment venues in Vancouver, British Columbia, Montreal, Quebec, and Toronto,
- Ontario in Q4-24. This adjustment adds the associated revenues and operating expenses
- LBE revenues and expenses associated with the 3 new locations were calculated as a percentage of revenues and expenses of historical periods.
- The Company had 13 LBE locations across the scope period and revenues and expenses were applied evenly to the 13 locations to calculate the associated revenues and expenses for each location.
- As of Dec-23, accounts payable comprises of trade payables valued at ($80.9 million), film payables and accruals ($25.4 million), accrued salaries and benefits ($27.9 million), sales taxes payable ($12.2 million), accrued occupancy costs ($2.4 million) and other payable and accrued liabilities ($23.6 million).
- The detailed breakdown for the account balance as at Mar-24 is unavailable, however, the increase is mainly attributed to the timing of trade payables and interest caused partly by the statutory holiday on March 31, 2024.
- Assets/liabilities held for sale - P1AG
- Trade and other receivables
- Prepaid expenses and other current assets
- Accounts payable and accrued expenses
- LBE revenue as a % of total revenue
...
- Revenue: The Company’s revenue is broken down into four main segments:
- Box office: Includes ticket sales for various films.
- Food service: Includes food and beverage purchases across all of the Company’s various offerings.
- Includes concessions and delivery in both theatres and location based entertainment venues.
- Media: Includes cinema media, which generates revenues primarily from selling pre-show and showtime advertising in theatres, and digital placed-based media, which provides solutions in quick-service restaurants, financial services, and malls. Cinema media revenue is generated by number of impressions which is driven by theatre attendance levels, whereas digital place based media is contract
- Amusement: Includes XSCAPE entertainment centers and game rooms in theatres as well as revenues generated at LBE venues. Amusement revenues are generated by ticket sales which are driven by theatre and LBE attendance levels.
- Film cost: Represents the film rental fees paid to distributors for films exhibited in the Company’s theatres.
- Film costs are calculated as a percentage of box office revenue and are dependent on various factors including the performance of the film. Film costs are accrued on the related box office receipts at either mutually agreed-upon terms or estimated terms.
- Cost of food service: Represents the cost of concession items and other theatre or LBE food service items sold. Revenues vary with the quantity and mix of concession items sold.
- Days payable outstanding
- Days sales outstanding
- Executive vice president
- Fiscal year ended December 31, 202X

# Income Statement
- associated with the Company’s 13 current location-based entertainment venues across the scope period.
- The estimated effect of the three new locations coming in Q1-24 is applied as if they existed historically. The effect is calculated by dividing each line item by 13 for each location, assuming each location creates equal revenues and expenses. This is then multiplied by three to give an estimation of the revenues and expenses associated with the three new locations. This is then summed together to reach the final EBITDA adjustment.
...
- Taxes and interest: This adjustment eliminates the associated taxes and interest of the Company’s joint ventures and associates.
- We consider this adjustment to be reasonable, under the assumption that these gain/losses stem from one time non-recurring events that are not expected to be part of normal
- We consider this adjustment to be reasonable as definitional EBITDA removes depreciation, amortization, taxes, and interest.
- Management adjustments (continued)
- Revenue, pro forma adjusted
- Cash rent paid/payable related to lease obligations
- Negotiated lease-related cash savings for the period
- Cash rent paid not pertaining to current period
- Unrealized gain (loss) on financial instruments recorded at fair value
...
- Impairment of long-lived assets, goodw ill and investments
- CDCP equity gain (loss)
- Pro forma adjustments
- EBITDA, pro forma adjusted
- EBITDA margin, pro forma adjusted
...
- Removal of P1AG revenue
- Realized foreign exchange gain (loss)
- Removal of P1AG impact 11. COVID subsidies: During the COVID-19 pandemic, the Company qualified for a variety of government subsidies including the Canada Emergency Wage Subsidy (“CEWS”), Canada
- Emergency Rent Subsidy (“CERS”) and Tourism and Hospitality Recovery Program (“THRP”). This adjustment eliminates the effect of these government subsidies.
- Payroll subsidies (“CEWS” and “THRP”): In response to the economic impact of COVID-19, the Government of Canada announced the CEWS program in Apr20. CEWS provides a wage subsidy to eligible employers based on certain criteria, such as demonstrated revenue declines as a result of COVID-19. This subsidy was retroactive from Q1-21 to Q3-22 within the scope period. The Company records this grant as an offset to the theatre payroll expense.
- Rent subsidies (“CERS” and “THRP”): The Government of Canada also announced the CERS program in Nov-20. CERS provides a rent and property tax subsidy for companies that demonstrate a decline in revenue. This subsidy was retroactive from Q1-21 to Q2-22 within the scope period. The Company records this grant as an offset to the relevant expense.
- accounts of assets and liabilities held for sale broken down into its The aside presents the corresponding total net working capital accounts.
- The aside presents the sum of the broken down assets and liabilities accounts to its corresponding net working capital accounts to find a total.
- This total represents each total net

# Net Working Capital
- Unless otherwise noted, the income statement and balance sheet are presented in $CAD and in thousands ($'000).
- The financial information presented herein reflects the consolidated results of the Company for fiscal years 2021, 2022, and 2023, as well as year to date March 2024. The Company’s fiscal-year end is December 31.
- The Company is audited annually by PricewaterhouseCoopers LLC. The most recent audit was completed for the fiscal year ended / as at December
- Financial statements have been built on a quarterly basis, in line with audited reported information released by the Company.
- The information sources used in the creation, analysis and presentation of this report are as follows:
- Quarterly audited financial statements from Cineplex Inc. Investor Relations
- Quarterly management discussion & analysis (MD&A) with Cineplex Management team.
- Quarterly earnings calls with Management team.
- Industry research from a variety reports and interviews
- Certain financial statement accounts remain consolidated and on a general level throughout the year, with general accounts being broken into constituent parts only at year end. This created an obstacle in determining the impact of certain accounts on a quarterly basis. Additionally, some financial statement accounts remain consolidated throughout the entire period, which limit the identification of business trends and further
- No further management contact was initiated. We consider access to management extremely limited.
- All financial information is sourced to the audited and reported public documents, with the accuracy and detailed required of a public company. Further qualitative information is represented by management through MD&A documents, earnings calls or other publications released by the company relating to investor relations.
- historical periods. The adjustment was calculated as a percentage of current assets and liabilities held for sale relating to P1AG to total current assets and liabilities for each aggregate gross capital commitments of $43.0 million ($35.0 million net of tenant inducements) related to the completion of construction of one theatre, three location-based entertainment locations, and other premium experiences.
- TTM adjusted net sales
- Adjusted WC, as a % of net sales
- Pro forma adjustments
- Revenue: Diligence adjusted revenue increased by 150.2% from $556.4 million in FY21 to $1.39 billion in the TTM Mar-24 period. This increase was primarily driven by an increase in box office revenue and food service revenue.
- Box office revenue – Increased by 155.0% from $236.3 million to $601.6 million across the scope period. The increase from FY21 to FY22 was primarily driven by increased theatre attendance levels as a result of theatres re-opening after COVID-19, as well as an increase in BPP. Increases from FY22 onwards were primarily due to an increase in attendace levels due to significant movie releases such as Barbie and Oppenheimer. BPP increases were inflationary within the TTM Mar-24 period and percentage of total box office from premium priced product decreased.
- Food service revenue – Increased by 159.0% from $187.0 million in FY21 to $483.9 million in the TTM Mar-24 period. This increase is primarily driven by increased theatre attendance levels, and management represents that an expansion of menu offerings drove
- CPP increases which drove food service revenues as well.
- Media revenue – Total media revenue saw an increase of 137.0% across the scope period which was primarily driven by an 82.0% increase in cinema media revenues from $33.0 million to $78.2 million. Digital place based media saw a relatively smaller increase of 25.17% which incorporates a 2.17% decrease in the FY23 period due to lower project revenues.
- Accounts receivable includes trade and other receivables. Trade receivables are amounts billed to customers for the sales of goods and services, and represent the maximum exposure to credit risk of financial assets, net of expected credit loss.
- Normal credit terms for amounts due from customers are within 30 to 45 days. Other receivables include amounts due from suppliers and landlords and other
- Inventories: Inventories consist of food service inventories, gaming inventories, and other inventories including work in progress.
- Food service inventories include merchandise that is used as redemption prizes which represented 66.98% of total inventory as of Dec-23.
- Gaming inventories include gaming equipment purchased for re-sale or transferred from property, equipment and leaseholds and merchandise that are used as redemption prizes for certain games which was not present in inventory as of Dec-23 due to the sale of P1AG.
- Other inventories include consumable supplies and work-in-progress being assembled for sale or installation by CDM which represented 33.02% of total inventory as of Dec-23.
- *Note: a breakdown of inventories is only presented at year end within the Company’s quarterly statements, therefore the breakdown within our discussion is presented as of
- Prepaid expenses and other current assets: Primarily consists of prepayments for real estate taxes, insurance and technology services.
- Diligence adjustments: Impact of QofE adjustments, identified during diligence as nonrecurring in nature.
- Pro forma adjustments: Adjustments made to normalize the impact of additional QofE adjustments identified during diligence to reflect previously non-existing items.
- The average diligence-adjusted NWC for FY23 is ($237.1million), marking a $32.9 million increase from FY22. This increase is primarily due to the exclusion of a one-time reorganization for Scene LP from deferred revenue.
- Cash and cash equivalents: The Company’s cash accounts have been excluded from working capital and form a part of net debt. This adjustment includes both cash accounts and the cash restricted through debt covenants.
- Income tax receivable: This account represents an amount that is owed to the company by the government, it is essentially an asset that can be converted into cash when the government repays it, hence items related to federal and local income taxes have been removed from net working capital and reclassified to net debt.
- Fair value of interest rate swap agreements (assets): Items related to decreasing foreign exchange rate exposure on interest expenses have been removed from net working capital, and reclassified to net debt.
- Assets held for sale: This account is a reclassification account for storing asset balances related to P1AG, which is no longer part of operations and hence has been removed from net working capital.
- Share based compensation: This account includes the balance of fair value in excess of the exercise price for cash settled options as a result of the arrangement agreement.
- This account has been removed from net working capital and included in the net debt.
- Income tax payable: This account represents an amount that the company owes to the government, which is a liability. Hence, items related to federal and local income taxes
- Lease obligations: This account relates to the long-term leases for properties and equipment, which is debt-like in nature and therefore has been removed from working
- Fair value of interest rate swap agreements (liabilities): Items related to decreasing
- Liabilities relate to assets held for sale: This account is a reclassification account for storing liabilities balances related to P1AG, which is no longer part of operations and hence has been removed from net working capital.
...
- Key management salary: Current executives include Ellis Jacob (CEO), Gord Nelson (CFO), Dan McGrath (COO), Fabrizio Stanghieri (EVP & MD, Media), and Kevin Watts (EVP,
- Exhibition & LBE). Total compensation for the FY23 period was $3.6 million, $1.5 million, $1.7 million, $719,000, and $696,000 for each executive respectively. Depending on any changes to management’s go-forward compensation, an appropriate bonus and payroll accrual will need to be established. Refer to the appendix for an executive compensation analysis of comparable The DPO shows slight fluctuations over the historical period, but maintains an average of 35 days. This stability can be attributed to enduring relationships with vendors and of the inherent characteristics of the industry.
- Industry-wide comparison between various high-level executives of industry-leading entertainment companies.
- Melissa Thomas (CFO)
- Michael Cavalier (General Counsel)
- Elizabeth Frank (CCO)
- Fabrizio Stanghieri (EVP & MD, Media)
- Valmir Fernandes (International President)
...
- Trade and other receivables
- Prepaid expenses and other current assets
- Accounts payable and accrued expenses assets and liabilities weren’t reclassed into assets and liabilities held for sale.
- The aside presents assets and liabilities held for sale as a percentage of the sum of assets and liabilities held for sale and their corresponding net that the amount of assets and liabilities relating to P1AG as a percentage of total assets and liabilities is the same throughout the historical period.
- The aside presents an estimate of assets and liabilities relating to P1AG throughout the historical period as a percentage of assets and liabilities held for sale to the total corresponding net working capital amounts.
- Assets/liabilities held for sale as a % of total
- Assets/liabilities relating to P1AG The aside presents the Company’s total revenue, LBE revenue, and LBE revenue as a percentage of total The aside presents the total net The aside presents a calculation of each account’s amount relating to LBE by multiplying the specific quarter’s
- LBE revenue percentage by the total amount and then multiplying by 3/13 to reach an amount for the three new
- LBE locations coming in Q1-24. It is assumed here that each LBE location has equal assets and liabilities.
...
- The decrease in property, equipment and leaseholds in FY23 is primarily due to a $25.1 million reclassification to assets held for sale, for P1AG.
...
- Long-term debt: Includes convertible debentures of $156.45 million and notes payable of $575.0 million.
...
- 10. Post employment benefit obligations: The Company sponsors a defined benefit supplementary executive retirement plan (“DB SERP”). The Company also sponsors the Retirement Plan for Salaried Employee of Famous
...
- Diligence adjustments: Represents adjustments identified during diligence for: (i) onetime or non-recurring expenditures, (ii) expenses unrelated to typical operational performance, and (iii) revisions to management adjustments.
- Pro forma adjustments: Represents adjustments to normalize revenues and expenses for previously non-existing items.
- Other considerations: Represents other items which were not included as adjustments due to a non-quantifiable or subjective nature. These items should be considered as part of the earnings analysis for sensitivity purposes.
- The Quality of Earnings (“QofE”) analysis has been prepared based on the Company’s quarterly publicly available financials.
- The suitability of EBITDA adjustments as it pertains to the proposed transaction and other factors for consideration may require further investigation to understand the potential impact on business model. The potential adjustments identified are not deemed to be allinclusive and further diligence may uncover additional or modified adjustments.
- Revenue, pro forma adjusted
- Pro forma adjustments
- EBITDA, pro forma adjusted
- EBITDA margin, pro forma adjusted
...
- Impairment of long-lived assets, goodw ill and investments
- CDCP equity gain (loss)
- Unrealized gain (loss) on financial instruments recorded at fair value: This adjustment eliminates the impact of the unrealized change in value of financial instruments recorded at fair value. The Company’s financial instruments primarily consist of convertible debentures, notes payable, and a credit facility. Changes in the fair value of these instruments are not part of the Company’s normal operations and do not have a cash effect, hence removed from EBITDA. The Q1-24 amount of $51.9 million is primarily due to the loss in refinancing
- Gain (loss) on disposal of assets: This adjustment eliminates gains (losses) recognized on assets or components of assets that were sold or otherwise disposed. The gain of $57.8 million in FY22 primarily relates to the reorganization of Scene LP as specific non-financial milestones were completed during Q3-22. The gain of $28.3 million in FY21 primarily relates to the sale of the Company’s head office buildings for gross proceeds of $57.0M in

# Forecast Trading
- due to the addition of 17 more locations in the future within new geographies and new concepts.
- Management is strategically focusing on diversification through their location based entertainment (LBE) segment to broaden their revenue streams and reduce reliance on traditional cinema operations. LBE revenues makes up 9.2% of total Company revenue, a 1.2% increase since FY21. LBEs saw an increase in adjusted store level
...
# Industry Analysis
- William Trudeau, Partner
- Toronto, Ontario, Canada The procedures we performed do not constitute an audit, examination or review in accordance with standards established by the Auditing and Assurance Standards Board (“AASB”) in Canada, and we have not otherwise verified the information we obtained or presented in this report. We express no opinion or any other form of assurance on the Target’s internal control over financial reporting or on the information presented in our report and make no representations concerning its accuracy or completeness.
- We have not compiled, examined, or applied other procedures in accordance with the Assurance and Related
- Services Guidelines issued by the AASB to prospective information contained in this document and, accordingly, express no opinion or any other form of assurance or representations concerning the accuracy, completeness or presentation format of such prospective information. There will usually be differences between projected and actual results, because events and circumstances frequently do not occur as expected, and those differences may be The data included in this report was received from the Target’s quarterly and annual reports from 2021 to Q1-2024.
- Since many aspects of the prospective transaction have either not been finalized or are not yet documented, changes may occur that materially affect the financial and other information we received and reported to you. We have no obligation to update our report or to revise the information contained herein to reflect events and transactions occurring after March 31, 2024.
- Because of its special nature, this report is not suited for any purpose other than to assist Client in its evaluation of the business and, as such and as agreed in the Engagement Agreement, this report may be provided to any any liability or responsibility to any third party who may use or place reliance on our report.
- Project Cinema — Buy-side Due Diligence
- We have completed our procedures to assist WT Inc. (“Client” or “you”) in performing financial due diligence in connection with your prospective investment (the “Transaction”) in Cineplex Inc. (the “Company”) in The objective of our engagement was to make inquiries and perform analyses based on information made available to us, directed toward those business activities and related financial data of interest to you. The objective of our engagement was to assist you as you evaluate potential strategic alternatives for the business. Our work was conducted based on information provided by publicly available financial statements and other commentary, obtained through quarterly reports and management discussion & analysis (MD&A) reports.
- involve advice or recommendations as to whether to proceed with the transaction. Additional due diligence procedures should be completed to the extent it considers necessary.
...
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 2: EBITDA bridge
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 3: COVID-19 recoverability
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 4: Location based entertainment
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 5: Future outlook
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 6: Historical Trading
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 7: Revenue drivers and cost levers – value creation
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 8: Industry salary comparison
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 9: Sale of Player One Amusement Group
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 10: Litigation arising from Cineworld transaction
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 11: Gross margin analysis
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 12: Segment analysis
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 13: QofE adjustment #12
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 14: NWC adjustment #10
- Table- or chart-based adjustment and metric details were excluded per extraction policy.

## Appendix 15: NWC adjustment #15
- Table- or chart-based adjustment and metric details were excluded per extraction policy.
