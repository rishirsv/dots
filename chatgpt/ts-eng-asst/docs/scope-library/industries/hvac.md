...
### Business Overview (`business_overview`)
- (scope.122) Obtain background information of Target, including its:
  - Organizational structure, ownership and management reporting relationships;
  - Product / service offerings;
  - Range of customer segments and regions served; and
...
### Quality Of Earnings (`quality_of_earnings`)
- (scope.123) Based on the analysis and discussion with the sell-side due diligence advisor, comment on Management's proposed adjustments to reported EBITDA (i.e. Executive compensation changes, personal expenses, one-time / non-recurring items, out-of-period adjustments, truck recovery rate increases, other etc.) and inquire about the nature and rationale of such adjustments and supporting documentation;
- (scope.124) Perform a traffic light assessment of Management and sell-side proposed adjustments;
- (scope.125) Propose any significant adjustments identified that are not reflected in the sell-side Quality of Earnings analysis; and
...
- (scope.137) Understand impact of Quality of Earnings adjustments on the the Historical Period budget
- (scope.138) Quality of earnings – To the extent not covered by the sell-side due diligence report. Assessment of any subsequent roll-forward of the sell-side quality of earnings report (if available) and propose potential incremental adjustments identified by considering:
  - Management's proposed adjustments to reported EBITDA;
  - The impact of revenue accounting and accounting / cash timing differences including:
...
### Capital Expenditure Requirements (`capital_expenditure_requirements`)
- (scope.184) Obtain and read an analysis of Target's existing capital costs and inquire about:
...
### Fy24 Outturn (`fy24_outturn`)
- (scope.186) Obtain the the Historical Period budget and forecast for the rest of the year. Interview management about the reasons for significant fluctuations with budget. Discuss and bridge to full-year the Historical Period forecast with management. Comment on predictability of current year's performance and level of confidence in achieving the the Historical Period budget.
...
- (scope.193) Consolidate the data into a clean data cube that can be leveraged by potential buyers
...
- (scope.212) Participate in buyer diligence calls
- (scope.213) Read and provide feedback to management with respect to their responses to potential Buyer (and their advisors) inquiries during the diligence process, specifically those related to financial / accounting matters.

### Optional Fdd Procedures (`optional_fdd_procedures`)
- (scope.214) Review purchase agreement and all relevant definitions (e.g. NWC, debt-like items definitions and adjustment procedures).
