...
## Industry module — `eyecare`

### Business Overview (`business_overview`)
- (scope.047) Read Target's financial statements and discuss them with management to gain an understanding of Target's accounting policies and practices, including:
  - Finance function, financial reporting framework, and management reporting relationships;
  - Significant accounting policies and estimates (e.g. revenue recognition, capitalized costs, deferred revenue) and contemplated changes
- (scope.048) Read Target's financial statements and discuss with Management to gain an understanding of the following:
  - Financial performance over the historical period;
  - Potential adjustments to the profit and loss performance identified by Management;
  - Accounting policies and practices.

### Quality Of Earnings (`quality_of_earnings`)
- (scope.049) Summarize potential adjustments identified regarding the profit and loss performance of Target in the form of a quality of earnings analysis, summarizing the risks that may impact earnings before interest, taxes, depreciation and amortization ("EBITDA"), including:
  - Leveraging Target commissioned Sell-side Due Diligence Report and understand proposed adjustments (including but not limited to cash to accrual, physician compensation, pro pricing adjustments, etc);
  - Large, unusual, and non-recurring events or transactions that may have distorted results;
  - The impact of provisions, management estimates or adjusting entries on the reported results; and
  - Other potential items discovered during the due diligence process.
- (scope.050) Provide a high-level analysis regarding the profit and loss performance of Target in the form of a quality of earnings analysis, summarizing the risks that may impact earnings before interest, taxes, depreciation and amortization ("EBITDA"), including:
  - Adjustments proposed by Target;
...
### Operating Expenses (`operating_expenses`)
- (scope.052) Physician and employee compensation and related costs by function;
- (scope.053) Rent;
- (scope.054) Professional fees;
- (scope.055) Any key supplier cost arrangements (i.e. volume rebates and minimum commitments, for top suppliers);
- (scope.056) Unusual and extraordinary items;
- (scope.057) Customer acquisition expense trends (e.g. Marketing, promotion and advertising);
- (scope.058) Other general and administrative expenses.
...
### Working Capital (`working_capital`)
- (scope.061) Obtain details on Target's working capital and conduct the following:
  - Monthly working capital trends, including seasonality, for the past 24 months;
  - Historical trends in key working capital metrics (DSO, DIO, DPO); and
  - on factors that may have distorted the current or historical working capital position.
- (scope.062) Obtain details on Target's working capital and conduct the following high-level analysis:
  - Monthly working capital trends, including seasonality, for the historical period;
- (scope.063) Comment on factors that may have distorted the current or historical working capital position.

### Accounts Receivable (`accounts_receivable`)
- (scope.064) Obtain and read an analysis of the Target's

### Inventories (`inventories`)
- (scope.065) Understand Target's underlying process for recording inventory and comment on unusual items.

### Other Current Assets (`other_current_assets`)
- (scope.066) Obtain and read an analysis of the Target's other current assets and comment on unusual items, significant fluctuations and the existence of other balances to be potentially excluded from working capital (e.g. income taxes recoverable and deferred finance costs)

### Accounts Payable And Accrued Liabilities (`accounts_payable_and_accrued_liabilities`)
- (scope.067) Obtain and read an analysis of Target's payables and accrued liabilities and inquire about:
  - Terms of trade with major suppliers, aging analysis;
  - Accrued liabilities; and

### Net Debt (`net_debt`)
- (scope.068) Summarize and comment on net debt items (on and off balance sheet) presented by management and other potential debt-like items.
- (scope.069) Analysis of remaining liabilities surrounding contingent consideration.
