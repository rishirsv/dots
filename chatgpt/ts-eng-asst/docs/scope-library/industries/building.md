...
- (scope.482) Assess payroll/union accruals (if applicable) and warranty/defect accruals where relevant.
- (scope.483) Review contingent liabilities related to claims, liquidated damages, and performance obligations.

### Work In Progress And Backlog (`work_in_progress_and_backlog`)
...
- (scope.486) Warranty obligations, claims, and litigation, including project-specific disputes.
- (scope.487) Purchase commitments and long-lead materials exposure.
