...
- Replaced industry sections: `accounts_payable_and_accrued_liabilities`, `accounts_receivable`, `commitments_and_contingencies`, `work_in_progress`
...
- (scope.472) Gain an understanding of the project/contracting model, including service lines, end markets, geographic footprint, and typical contract types.
- (scope.473) Understand backlog, bidding pipeline, and key customers/projects, including customer concentration.
- (scope.474) Understand subcontractor usage, sourcing/procurement practices, and key suppliers.
...
- (scope.475) Analyze revenue and gross margin trends by project type, geography, and major customer.
- (scope.476) Understand contract pricing structures (fixed price, time and materials, unit price) and change order practices.
- (scope.477) Assess seasonality and weather/field-operations impacts on revenue and margin.
...
- (scope.478) Understand billing practices, including progress billings, retention, and contract assets/liabilities.
- (scope.479) Review aging, collectability, disputes/claims, and change-order collectability.
- (scope.480) Assess concentration and credit risk by customer and project.
...
- (scope.481) Understand subcontractor payables, accrued costs, and cut-off practices.
- (scope.482) Assess payroll/union accruals (if applicable), accrued project costs, and cut-off controls for subcontractor and supplier expenses.
...
- (scope.485) Bonding capacity and surety requirements (if applicable).
- (scope.486) Warranty obligations, claims, liquidated damages, and performance obligations, including project-specific disputes.
- (scope.487) Long-lead materials exposure, escalation clauses, and related purchase commitments.
