...
- (scope.488) Gain an understanding of product lines, programs, customers (OEM/tier relationships), and regulatory/quality requirements.
- (scope.489) Understand backlog, program life cycles, and ramp/production cadence.
- (scope.490) Understand manufacturing footprint, capacity constraints, and supply chain dependencies.
...
- (scope.491) Analyze revenue and gross margin trends by program, customer, and product line.
- (scope.492) Understand contract structures (long-term agreements, pricing escalators, penalties/claims) and revenue recognition approach.
- (scope.493) Assess customer concentration, order volatility, and backlog conversion assumptions.
...
- (scope.495) Understand capex requirements for tooling, equipment, and capacity expansion.
- (scope.496) Assess maintenance capex versus growth capex and related replacement cycles.
- (scope.497) Review capitalized development/tooling costs (if applicable) and impairment considerations.
